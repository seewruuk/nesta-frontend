...
export default function StateContextProvider({children}) {
    ...
    const [links, setLinks] = useState([{
        ...
        name: "Oferty",
        href: "/dashboard/rental-offers",
        icon: icons.rentaloffers
    ...
    const [messages, setMessages] = useState([{
        id: "i15n123ior5", from: "Kacper Sewruk", messages: [{
            ...
            origin: "tenant", text: "Wszystko będzie gotowe 🙂", date: "2025-01-23T09:25:00Z", isRead: false
        }, {
            origin: "owner", text: "Super, do zobaczenia w sobotę.", date: "2025-01-23T09:30:00Z", isRead: true
        }]
    }, {
        id: "i15n123ior6", from: "Joanna Kowalska", messages: [{
            origin: "tenant",
            ...
            origin: "tenant", text: "Ok, dziękuję. Do zobaczenia w piątek.", date: "2025-01-22T15:15:00Z", isRead: false
        }, {
            origin: "owner",
    ...
    return (<StateContext.Provider value={{
            links, transactions, messages,

            setLinks, setTransactions, setMessages
        }}>
            {children}
