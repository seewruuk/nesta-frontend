        ...
        <div className={"w-1/6 px-[48px] py-[32px] bg-white flex flex-col justify-between"}>
            ...
            <div className={"flex-grow flex flex-col justify-start items-start gap-[52px]"}>
                ...
                <div className={"flex flex-col items-center w-full"}>
                    <div
                        className={"relative aspect-square h-[120px] border-white border-[7px]"}>
                        <Image
                        ...
                        />
                        <div
                            className={"absolute rounded-full border-4 border-white bottom-0 right-0 h-[32px] aspect-square bg-primary"}/>
                    </div>
                    <div className={"text-[15px] text-center flex flex-col items-center gap-1"}>
                        ...
                        <div className={"font-semibold"}><span
                            className={"bg-gray-200 text-gray-500 px-2 py-1 rounded-md"}>4.25</span> / 5.00
                        </div>
                    </div>
