...
export default function UploadImages({appId}) {
    ...
    const canUpload = Boolean(appId) && Boolean(accessToken) && selectedFiles.length > 0 && !isUploading;
    ...
    return (<>
        ...
        <DashboardElement>
            <div className="flex-col gap-4">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    {selectedFiles.length > 0 && (<ul className="list-disc list-inside text-sm text-gray-700">
                        {selectedFiles.map((f, i) => (<li key={`${f.name}-${i}`}>
                    ...
                    {!appId && (<p className="text-xs text-red-600">
        ...
        {appImages && appImages.length > 0 && (<DashboardElement>
            <div className="flex-col gap-4">
                <div className="mb-2">
...
const TrashIcon = ({className = "h-5 w-5"}) => (<svg
...
>
    <path
        d="M9 3a1 1 0 0 0-1 1v1H5.5a1 1 0 1 0 0 2H6v12a3 3 0 0 0 3 3h6a3 3 0 0 0 3-3V7h.5a1 1 0 1 0 0-2H16V4a1 1 0 0 0-1-1H9Zm2 2h2v1h-2V5ZM8 7h8v12a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1V7Zm2.75 3a.75.75 0 0 0-.75.75v7.5a.75.75 0 0 0 1.5 0v-7.5a.75.75 0 0 0-.75-.75ZM14 10a.75.75 0 0 0-.75.75v7.5a.75.75 0 0 0 1.5 0v-7.5A.75.75 0 0 0 14 10Z"/>
</svg>);
...
function GalleryTile({img, index, onDelete, appId}) {
        ...
        try {
            ...
            const response = await fetch(`${baseUrl}/api/apartments/delete-image`, {
                method: "POST", headers: {
                    ...
                    accessToken: accessToken, apartmentId: appId, imageId: imageId,
                }),
            });
    ...
    >
        ...
        <span
            className="pointer-events-none absolute inset-0 rounded-xl ring-0 ring-blue-500/0 focus-within:ring-2"/>
    </div>);
}
