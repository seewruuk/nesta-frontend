...
export default function LikedOffers({apartments}) {
    return (
        <DashboardElement>
            {
                sectionHeader("Zapisane oferty")
            }
                    ...
                    return (
                        ...
                        >
                            <div className="h-[184px] w-[280px] rounded-2xl relative">
                                <Image src={item.images[0]} fill alt={item.header} className="rounded-2xl object-cover"/>
                            </div>
                            {generateLabel("available")}

                            {/* tu dodajemy klasy do przycinania */}
